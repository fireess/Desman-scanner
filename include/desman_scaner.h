...
#ifndef DESMAN_SCANER_H
#define DESMAN_SCANER_H
#   include "../include/desman_lexeme.h"
#   include "../include/abstract_scaner.h"
#   include "../include/category.h"
namespace desman_scanner{
    using Lynx_token = ascaner::Token<desman_scanner::Lexeme_info>;

    class Scanner : public ascaner::Abstract_scaner<desman_scanner::Lexeme_info>{
    public:
        Scanner()               = default;
        Scanner(const ascaner::Location_ptr& location, const Errors_and_tries& et) :
            ascaner::Abstract_scaner<desman_scanner::Lexeme_info>(location, et) {};
        Scanner(const Scanner&) = default;
        virtual ~Scanner()      = default;

        ascaner::Token<desman_scanner::Lexeme_info> current_lexeme() override;

        std::string lexeme_to_string(const desman_scanner::Lexeme_info& li) override;
    private:
