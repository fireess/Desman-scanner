...
#include "../include/desman_scaner_delimiter_table.h"
...
//             token_.lexeme_.char_val_ = char_code_;
    ...
    ascaner::Token<desman_scanner::Lexeme_info> Scanner::current_lexeme()
    {
        automaton_           = Automaton_name::Start;
        token_.lexeme_.code_ = Lexem_code::Nothing;
        lexeme_begin_        = loc_->pcurrent_char_;
...
"Kw_ Iam",
    ...
    std::string Scanner::lexeme_to_string(const desman_scanner::Lexeme_info& li)
    {
        std::string result;
        auto        lc     = li.code_;
